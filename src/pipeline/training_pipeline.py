...
class TrainPipeline:
    ...
    def start_model_evaluation(self, model_trainer_artifact: ModelTrainerArtifact) -> ModelEvaluationArtifact:
        ...
        try:
            ...
            logging.info(f'Performed the model evaluation operation')
    ...
    def start_model_pusher(self, model_evaluation_artifact: ModelEvaluationArtifact) -> ModelPusherArtifact:
        '''
        This method of TrainPipeline class is responsible for startinf model pusher component
        '''
        try:
            model_pusher = ModelPusher(model_pusher_config = self.model_pusher_config,
                                       model_evaluation_artifact = model_evaluation_artifact)
            model_pusher_artifact = model_pusher.initiate_model_pusher()
            logging.info(f'Performed the model pusher operation')
            logging.info(f'Exited the start_model_pusher method of TrainPipeline class')
